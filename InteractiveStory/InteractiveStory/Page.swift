...
extension Page {
    ...
    func addChoiceWith(title: String, story: Story) -> Page { //METHOD OVERLOADING EXAMPLE
        let page = Page(story: story)
        return addChoiceWith(title: title, page: page)
        
    }
    
    func addChoiceWith(title: String, page: Page) -> Page { //METHOD OVERLOADING EXAMPLE
        switch (firstChoice, secondChoice) {  //GREAT DESIGN REFERENCE
